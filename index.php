...
<div class="gs-container">
    <div class="grid-stack">
        ...
        <div class="grid-stack-item" id="widget-sun"
             gs-x="0" gs-y="0" gs-w="3" gs-h="5" gs-min-w="2">
        ...
        <div class="grid-stack-item" id="widget-qth"
             gs-x="3" gs-y="0" gs-w="3" gs-h="5" gs-min-w="2">
            <div class="grid-stack-item-content">
        ...
        <div class="grid-stack-item" id="widget-bands"
             gs-x="6" gs-y="0" gs-w="4" gs-h="5" gs-min-w="3">
            <div class="grid-stack-item-content">
                <?php include __DIR__ . '/widgets/bands.php'; ?>
            </div>
        </div>

        <div class="grid-stack-item" id="widget-clock"
             gs-x="10" gs-y="0" gs-w="2" gs-h="5" gs-min-w="2">
            <div class="grid-stack-item-content">
        ...
        <div class="grid-stack-item" id="widget-weather-local"
             gs-x="0" gs-y="5" gs-w="4" gs-h="4" gs-min-w="2">
            <div class="grid-stack-item-content">
                <?php include __DIR__ . '/widgets/weather-local.php'; ?>
            </div>
        </div>

        <div class="grid-stack-item" id="widget-weather-space"
             gs-x="4" gs-y="5" gs-w="8" gs-h="4" gs-min-w="3">
            <div class="grid-stack-item-content">
